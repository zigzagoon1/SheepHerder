    ...
    void geom(point v2g IN[1], inout TriangleStream<g2f> triStream)
    {
        ...
        for (int j = 0; j < (GrassBlades * distanceFade); j++)
        {
            ...
            for (int i = 0; i < GrassSegments; i++)
            {
                ...
                triStream.Append(GrassVertex(v0, segmentWidth, segmentHeight, offset, segmentForward, float2(0, t), transformMatrix, faceNormal, color, worldPos));
                triStream.Append(GrassVertex(v0, -segmentWidth, segmentHeight, offset, segmentForward, float2(1, t), transformMatrix, faceNormal, color, worldPos));
            ...
            triStream.Append(GrassVertex(v0 + wind1, 0, _GrassHeight, offset, forward, float2(0.5, 1), transformationMatrix, faceNormal, color, worldPos));
