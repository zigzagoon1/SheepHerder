Shader "Custom/UnityBookFurShader"
{
    Properties
    {
        ...
        _FurLength ("FurLength", Range(0.0002, 1)) = 0.25
        _Cutoff ("Alpha Cutoff", Range(0,5)) = 0.5 //how thick
        _CutoffEnd ("Alpha Cutoff end", Range(0, 5)) = 0.5 //how thick they are at the end
