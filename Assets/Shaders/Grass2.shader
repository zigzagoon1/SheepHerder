Shader "Geometry/Grass2"
{
    Properties
    {
        ...
        //Grass blades
        _GrassBlades("Grass blades per triangle", Range(0, 20)) = 1
        _MinimunGrassBlades("Minimum grass blades per triangle", Range(0, 20)) = 1
    ...
    SubShader
    {
        ...
        CGINCLUDE
            ...
            void geom(triangle v2g input[3], inout TriangleStream<g2f> triStream)
            {
                ...
                for (int j = 0; j < 3; j++) {
                    triStream.Append(GetVertex(input[j].vertex, float2(0,0), fixed4(0,0,0,1)));
                }
