...
using UnityEngine.UI;
    ...
    public class FurBehavior : MonoBehaviour
    {
        ...
        protected void Draw()
        {
            ...
            Matrix4x4 viewValue = testCamera.projectionMatrix;
            // viewValue = camera.worldToCameraMatrix;
            Matrix4x4 projectionValue = testCamera.projectionMatrix;
        ...
        void DrawGeometry(MaterialPropertyBlock props)
        {
            ...
            Graphics.DrawMesh(verticesMesh, pos, rot, material, 0, testCamera, 0, props);
        }
